      ...
      if @message.save
        ...
        format.turbo_stream do
          render turbo_stream: [
            ...
            turbo_stream.update('msg_counter', html: "#{ Message.count}" ),
    ...
    respond_to do |format|
      format.turbo_stream do
         render turbo_stream: [
           ...
           turbo_stream.update("msg_counter", Message.count ),
           turbo_stream.update('notice', "Message #{@message.id} deleted Successfully!!!!!!!!!!!!" )
